<template>
    <footer class="bg-[#1a1a1a] border-t border-[#cba358]/20 pb-24 md:pb-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                <div class="flex flex-col">
                    <span class="text-xl tracking-widest font-serif text-[#cba358] uppercase leading-none">Nexora</span>
                    <span class="text-[8px] tracking-[0.3em] text-gray-400 uppercase mt-1">Moments</span>
                </div>
                <div class="text-xs text-gray-500">
                    &copy; {{ new Date().getFullYear() }} Nexora Moments. All rights reserved.
                </div>
