  ...
  <AdminLayout>
    <div class="space-y-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <!-- Users count card -->
        <div class="bg-slate-950 border border-slate-800/80 rounded-2xl p-6 relative overflow-hidden shadow-xl shadow-slate-950/20 group">
          <div class="absolute -right-4 -bottom-4 opacity-5 text-indigo-400 group-hover:scale-110 transition-transform duration-300">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <!-- Recent posts list -->
        <div class="lg:col-span-2 bg-slate-950 border border-slate-800 rounded-2xl p-6 shadow-xl shadow-slate-950/20 space-y-6">
          <div class="flex items-center justify-between">
            <div>
            ...
            <Link :href="route('admin.posts.index')" class="text-xs text-indigo-400 hover:text-indigo-300 font-semibold flex items-center gap-1">
          ...
          <div class="divide-y divide-slate-800/60">
            ...
            >
              <div class="min-w-0 space-y-1">
                <span class="text-xs font-semibold text-indigo-400 px-2 py-0.5 bg-indigo-500/10 rounded-full border border-indigo-500/25">
        ...
        <div class="bg-slate-950 border border-slate-800 rounded-2xl p-6 shadow-xl shadow-slate-950/20 space-y-6">
          <div>
          ...
          <div class="space-y-4 text-sm text-slate-400">
            <div class="p-3 bg-slate-900 rounded-xl border border-slate-800/80">
